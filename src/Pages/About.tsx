  ...
  return (
    <div>
      <div>
        ...
        <div className="flex items-center md:flex-row flex-col justify-center gap-8 p-[50px]">
          <div className="flex flex-col gap-2 2xl:w-[35%] xl:w-[40%] md:w-[50%] w-[100%]">
          ...
          <div className=" 2xl:w-[35%] xl:w-[40%] md:w-[50%] w-[100%]">
            <AboutImage src={history} />
          </div>
        </div>

        <div className="flex items-center md:flex-row flex-col justify-center gap-8 p-[50px]">
          <div className=" 2xl:w-[35%] xl:w-[40%] md:w-[50%] w-[100%] md:order-1 order-2">
            <AboutImage src={home_solutions} />
          </div>
          <div className="flex flex-col gap-2 2xl:w-[35%] xl:w-[40%] md:w-[50%] w-[100%] md:order-2 order-1">
